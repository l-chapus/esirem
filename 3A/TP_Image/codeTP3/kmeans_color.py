...
im = Image.open('C:/Users/louka/Desktop/Github/esirem/3A/TP_Image/codeTP3/EtretatP.jpg')
arr = np.asarray(im)

out = Image.open('C:/Users/louka/Desktop/Github/esirem/3A/TP_Image/codeTP3/out2.jpg').convert('L')
