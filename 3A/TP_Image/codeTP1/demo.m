...
nom=input('Entrer le nom image avec le format jpg, bmp ou tif :',E:/Université de Bourgogne/ESIREM 3A IE - Traitement du signal et des images/TP/Enoncés TP Images/Capsule.bmp);
a=imread(nom);
figure(1);
subplot(2,2,1);
imagesc(a);
